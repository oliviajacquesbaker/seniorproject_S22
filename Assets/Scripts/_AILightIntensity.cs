...
public class _AILightIntensity : MonoBehaviour
{
    ...
    private void AiPassThrough()
    {
        float perceivedLight = (LightLevel - defaultLightLevel) / 10000;

        _AIStatsController ai = GetComponent<_AIStatsController>();
        ai.UpdateHealth(perceivedLight); //Passes perceived light values to AI health controller.
